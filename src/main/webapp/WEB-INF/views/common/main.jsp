	...
	*/
	...
	$.ajax({
		...
		success: function(data){
			...
			for(var i in json.list){
				values += "<tr><td>" + json.list[i].no + "</td><td><a href='ndetail.do?noticeno=" + json.list[i].no + "'>" 
	...
	$.ajax({
		...
		success: function(data){
			...
			var values = "";
			for(var i in json.list){
				values += "<tr><td>" + json.list[i].bnum + "</td><td><a href='bdetail.do?bnum=" + json.list[i].bnum + "'>" 
